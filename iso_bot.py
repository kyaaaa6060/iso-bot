...
def calculate_iso_bot(df):
    ...
    # Fisher Sinyali
    stoch_over98 = (stoch_k >= 98).any() # Basit kontrol
    ...
    up_count_prev = 1 if fish_series.iloc[-3] > fish_series.iloc[-4] else 0 # Örnek basitleştirme
            ...
            for tf_name, tf_val in intervals.items():
                ...
                if df is not None and not df.empty:
                    ...
                    if buy and last_signals.get(tf_name) != key:
                        ...
                        send_telegram(msg)
                        print(f"[{tf_name}] Sinyal gönderildi!")
